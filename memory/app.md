...
- **Marcadores y clusters:** los marcadores individuales usan una miniatura circular de la foto principal y muestran el total de fotos cuando corresponde; `ol/source/Cluster` agrupa puntos cercanos o con coordenadas identicas, indicando el total de imagenes con el color terciario. La capa de publicaciones invalida sus estilos al terminar cada miniatura y al cambiar de tema, de modo que imagenes y bordes se actualizan sin mover ni ampliar el mapa.
